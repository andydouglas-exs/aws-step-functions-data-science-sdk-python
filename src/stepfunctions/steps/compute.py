...
class StepFunctionTaskStep(Task):

    """
    Creates a Nested StepFunctionTask State. See `Manage AWS Step Functions Executions as an Integrated Service <https://docs.aws.amazon.com/step-functions/latest/dg/connect-stepfunctions.html` for more details.
    """
    ...
    def __init__(self, state_id, wait_for_completion=True, **kwargs):
        ...
        super(StepFunctionTaskStep, self).__init__(state_id, **kwargs)
